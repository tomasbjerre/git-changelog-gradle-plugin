...
public class GitChangelogTask extends DefaultTask {
	...
	public void setIgnoreCommitsIfMessageMatches(
	...
	public void setIgnoreCommitsWithoutIssue(
	...
	public void gitChangelogPluginTasks() throws TaskExecutionException {
		try {
			this.getProject().getExtensions()
					.findByType(GitChangelogPluginExtension.class);
			...
			if (this.isSupplied(this.settingsFile)) {
				builder.withSettings(this.getProject().file(this.settingsFile)
						.toURI().toURL());
			}
